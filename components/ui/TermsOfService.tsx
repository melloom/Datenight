...
const TermsOfService = () => {
  return (
    <div>
      ...
      <p>
        Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the application (the "Service") operated by Melloow ("us", "we", or "our").
      </p>
      <p>
      ...
      <p>
        By creating an account, you agree to these Terms of Service. You are responsible for safeguarding your account
      ...
      <p>
        ...
        Melloow and its licensors.
      </p>

      <h2>4. Disclaimers</h2>
      <p>
        The Service is provided on an "AS IS" and "AS AVAILABLE" basis. We make no warranties, expressed or implied, and
        hereby disclaim and negate all other warranties.
      </p>

      <h2>5. Limitation of Liability</h2>
      <p>
        In no event shall Melloow, nor its directors, employees, partners, agents, suppliers, or
      ...
      <p>Any dispute arising from the use of the Service will be resolved through binding arbitration in [Your City, State].</p>

      <h2>9. Changes to Terms</h2>
      <p>
        We reserve the right, at our sole discretion, to modify or replace these Terms at any time. We will provide at
