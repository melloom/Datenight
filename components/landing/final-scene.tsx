  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        {/* Large text */}
        <h2 
          className={`font-serif text-5xl md:text-7xl lg:text-9xl leading-[0.9] tracking-tight mb-8 transition-all duration-1000 ${
        ...
        {/* Subtext */}
        <p 
          className={`text-lg md:text-xl text-muted-foreground max-w-lg mx-auto mb-14 transition-all duration-1000 delay-200 ${
        ...
        >
          <Link href={user ? "/" : "/login"}>
            <button className="group relative px-10 py-4 bg-primary text-primary-foreground font-medium uppercase tracking-[0.15em] text-sm overflow-hidden rounded-full">
          ...
          <Link href="/about" className="px-8 py-4 border border-border rounded-full text-sm font-medium uppercase tracking-[0.15em] hover:border-primary/50 hover:text-primary transition-colors">
            Learn More
          </Link>
        </div>
        ...
        {/* Stats row */}
        <div 
          className={`flex flex-wrap items-center justify-center gap-12 md:gap-20 transition-all duration-1000 delay-500 ${
            isInView ? "opacity-100" : "opacity-0"
          }`}
        >
          <div className="text-center">
            <span className="block font-serif text-4xl md:text-5xl text-primary">1K+</span>
            <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground mt-1 block">Date Spots</span>
          </div>
          <div className="w-px h-10 bg-border hidden sm:block" />
          <div className="text-center">
            <span className="block font-serif text-4xl md:text-5xl text-primary">4.9</span>
            <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground mt-1 block">User Rating</span>
          </div>
          <div className="w-px h-10 bg-border hidden sm:block" />
          <div className="text-center">
            <span className="block font-serif text-4xl md:text-5xl text-primary">50+</span>
